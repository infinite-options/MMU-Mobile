    ...
    <ImageBackground source={backgroundImage} style={styles.backgroundImage} resizeMode='cover'>
      ...
      <View style={styles.formContainer}>
        <View style={styles.roundedBox}>
          ...
          <TextInput style={styles.input} placeholder='Email' keyboardType='email-address' value={formDataLogin.email} onChangeText={(text) => handleChange("email", text)} />
          <TextInput style={styles.input} placeholder='Password' secureTextEntry value={formDataLogin.password} onChangeText={(text) => handleChange("password", text)} />
          ...
          <Text style={styles.subText}>Diam pulvinar pharetra nulla dolor nullam. Neque aliquam est amet scelerisque. Massa aenean.</Text>
