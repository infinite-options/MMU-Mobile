        ...
        try {
            ...
            try {
                ...
                if (result.message === "User already exists") {
                    ...
                    Alert.alert(
                        'User Already Exists', 
                        'This Google account is already registered. Would you like to log in instead?',
                        [
                            { 
                                text: 'Cancel', 
                                style: 'cancel'
                    ...
                    if (result.user_uid) {
                        ...
                        Alert.alert('Success', 'Your account has been created successfully! Please log in now.', [
            ...
            <View style={styles.socialContainer}>
                <TouchableOpacity 
                    style={[
                        ...
                        signInInProgress && styles.disabledButton
                    ]}
