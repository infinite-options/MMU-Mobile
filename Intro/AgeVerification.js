...
const AgeVerification = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtext}>This app requires you to be 18 years or older to enter.</Text>
      <Text style={styles.subtext}>Please enter your Date of Birth in the fields below in order to continue:</Text>

      <View style={styles.pickerContainer}>
        {/* Month Picker */}
        <Picker selectedValue={selectedMonth} style={styles.pickerStyle} onValueChange={(val) => setSelectedMonth(val)}>
        ...
        {/* Day Picker */}
        <Picker selectedValue={selectedDay} style={styles.pickerStyle} onValueChange={(val) => setSelectedDay(val)}>
        ...
        {/* Year Picker */}
        <Picker selectedValue={selectedYear} style={styles.pickerStyle} onValueChange={(val) => setSelectedYear(val)}>
          {yearsList.map((year) => (
